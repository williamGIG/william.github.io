<template>
  <div>
    <div class="shopcart">
      <div class="content">
        <div class="content-left"  @click="showList">
          ...
          <div class="price" :class="{'heighlight':totalCount}">￥{{totalPrice}}</div>
      ...
      <transition name="move">
        <div class="shopcart-list" v-if="isShowList&&totalCount">
    ...
    <div class="list-mask" v-if="isShowList&&totalCount" @click="showList"></div>
  </div>
</template>
