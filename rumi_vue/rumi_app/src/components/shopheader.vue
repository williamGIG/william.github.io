<template>
  <div class="shop-header">
    ...
    <div class="shop-content"  @click="shopInfoShow">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="supportShow">
      <!----三級表達式報錯info.supports[0].name，加v-if控制-->
    ...
    <transition name="fade">
      ...
      <div class="shop-brief-modal" v-show="showShop">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="shopInfoShow">
      ...
      <div class="activity-sheet" v-show="showSupport">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            ...
            v-for="(item,index) in info.supports" :key="index" :class="supportsClass[item.type]">
            <span class="content-tag" >
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-close" @click="supportShow"></span>
          </div>
        </div>
